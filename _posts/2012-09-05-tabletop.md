...
If you would prefer to batch upload a series of images at once, you can do this from the ***Your Art Library*** window that you can access from the [Art Library](/sidebar-art-library) tab of the [Sidebar](/sidebar). There is a 10 files/5 MB file size per batch limitation to batch uploads.
